...
Visual: The video returns to the book's cover art, with the title "A Novel of Mysteries and the Known" clearly visible. The narrator's name, "Jon Constantine," is shown. A call to action appears on screen.

Author
Jon-Arve Konstantin Grønsberg-Ovesen
You want three short video concepts, each about eight seconds long, for a book titled **"A Novel of Mysteries and the Known" by Jon Constantine**. Here are the concepts based on your descriptions.
